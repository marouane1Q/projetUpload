        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="product-details">
                    ...
                    <div>
                        <h3 class="product-price">DH {{$product->discount}} <del class="product-old-price">DH {{$product->price}}</del></h3>
...
<script>
    ...
    $(document).ready(function() {
		...
		$("#order_form").validate({
            ...
            document.getElementById("for_error").innerHTML = "<label class='error' style=' '>Entrée de variation non valide</label>";
